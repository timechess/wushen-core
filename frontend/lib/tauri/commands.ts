...
export async function saveTrait(
  packId: string,
  payload: Trait,
): Promise<string> {
...
export async function getAttackSkill(
  packId: string,
  id: string,
): Promise<AttackSkill | null> {
  return invoke("get_attack_skill", { packId, id });
}

export async function saveAttackSkill(
  packId: string,
  payload: AttackSkill,
): Promise<string> {
...
export async function deleteAttackSkill(
  packId: string,
  id: string,
): Promise<void> {
...
export async function getDefenseSkill(
  packId: string,
  id: string,
): Promise<DefenseSkill | null> {
  return invoke("get_defense_skill", { packId, id });
}

export async function saveDefenseSkill(
  packId: string,
  payload: DefenseSkill,
): Promise<string> {
  return invoke("save_defense_skill", { packId, payload });
}

export async function deleteDefenseSkill(
  packId: string,
  id: string,
): Promise<void> {
...
export async function listAdventureEvents(
  packId: string,
): Promise<NamedItem[]> {
  return invoke("list_adventure_events", { packId });
}

export async function getAdventureEvent(
  packId: string,
  id: string,
): Promise<AdventureEvent | null> {
  return invoke("get_adventure_event", { packId, id });
}

export async function saveAdventureEvent(
  packId: string,
  payload: AdventureEvent,
): Promise<string> {
  return invoke("save_adventure_event", { packId, payload });
}

export async function deleteAdventureEvent(
  packId: string,
  id: string,
): Promise<void> {
...
export async function deleteStoryline(
  packId: string,
  id: string,
): Promise<void> {

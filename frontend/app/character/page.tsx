...
export default function EnemyListPage() {
  ...
  const [enemyPreview, setEnemyPreview] = useState<{ enemy: EnemyTemplate; title: string } | null>(null);
  ...
  const handlePreview = useCallback(async (id: string) => {
    ...
    try {
      ...
      setEnemyPreview({ enemy: enemyData, title: enemyData.name || '未命名敌人' });
    } catch (error) {
  ...
  const renderEntryBlocks = useCallback((entries: Entry[]) => {
  ...
  const renderEnemyPanel = useCallback((enemy: EnemyTemplate) => {
  ...
  }, [getManualRealmEntries, renderEntryBlocks, resolveManualLabel, resolveTraitName, traitLookup]);
  ...
  return (
    <div className="page-shell">
      ...
      >
        ...
        {!previewLoading && enemyPreview && gameData && renderEnemyPanel(enemyPreview.enemy)}

...
function applyPanelDelta(panel: BattlePanel, delta?: PanelDelta, reverse: boolean = false) {
  ...
  if (delta.max_damage_reduction_delta !== undefined) {
    panel.max_damage_reduction = Math.max(0, panel.max_damage_reduction + delta.max_damage_reduction_delta * multiplier);
  ...
  if (delta.max_qi_output_rate_delta !== undefined) {
    panel.max_qi_output_rate = Math.max(0, panel.max_qi_output_rate + delta.max_qi_output_rate_delta * multiplier);

...
import { deleteTrait, getTrait, listTraits, saveTrait } from '@/lib/tauri/commands';
...
export default function TraitsEditorPage() {
  ...
  const handleEdit = async (id: string) => {
    try {
      ...
      alert(`获取特性失败: ${error instanceof Error ? error.message : '未知错误'}`);
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">特性编辑器</h1>
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            {traits.length === 0 ? (
              <div className="text-center py-16">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">暂无特性数据</h3>

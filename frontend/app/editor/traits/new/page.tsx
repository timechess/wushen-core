...
export default function NewTraitPage() {
  ...
  // 自动保存草稿
  useEffect(() => {
    if (hasUnsavedChanges && (trait.name || trait.description || trait.entries.length > 0)) {
      ...
      <div className="page-shell">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">新建特性</h1>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-lg p-6">
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-200">
                <div>
                  <h2 className="text-xl font-semibold text-gray-900">词条列表</h2>
              ...
              {trait.entries.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="mt-2 text-sm font-medium text-gray-900">暂无词条</h3>
                  <p className="mt-1 text-sm text-gray-500">点击上方按钮添加第一个词条</p>
                </div>
              ) : (
                <div className="space-y-4">

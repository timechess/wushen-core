...
export default function NewInternalPage() {
  ...
  useEffect(() => {
    ...
    if (draft) {
      ...
      // 创建默认的5个境界
      const defaultRealms: InternalRealm[] = Array.from({ length: 5 }, (_, i) => ({
        level: i + 1,
        exp_required: 0,
        qi_gain: 0,
      ...
      <div className="page-shell">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">新建内功</h1>
            ...
            <div className="flex gap-3">
              ...
              <Button
                onClick={handleSave}
                disabled={loading || !internal.name || internal.realms.length !== 5}
              >
                {loading ? '保存中...' : '保存'}
              </Button>
            </div>

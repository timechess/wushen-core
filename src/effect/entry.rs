...
use super::effect::{Effect, AttributeTarget, Operation};
...
impl Entry {
    ...
    fn get_allowed_operations(trigger: Trigger) -> Vec<Operation> {
        ...
        match trigger {
            Trigger::SwitchingCultivation => {
                // 转修时允许所有操作
                vec![Operation::Add, Operation::Subtract, Operation::Set, Operation::Multiply]
            }
            Trigger::BattleStart | Trigger::BeforeAttack | Trigger::BeforeDefense | Trigger::AfterAttack | Trigger::AfterDefense | Trigger::RoundEnd => {
                // 战斗时允许所有操作
                vec![Operation::Add, Operation::Subtract, Operation::Set, Operation::Multiply]
            }
            _ => {
